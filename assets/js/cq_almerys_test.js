...
$(function() {
  ...
  //test
    ...
    //      "          <th  class='text-center'>DETAILS ANOMALIE</th>"+
          "          <th  class='text-center' style='min-width:350px;'>LISTE ANOMALIE</th>";
        ...
        for (var i = 0 ; i<data.length ; i++)
        {
         ...
         // var matr= data[i].matriculesaisie;
          if(Number(sp)== 701 || Number(sp)== 702  || Number(sp)== 703  || Number(sp)== 704 || Number(sp)== 721 ){
            htm_td_num += "<td><a class='' href='#' data-toggle='modal' data-target='#grille-aglae' onclick='loadModal(\""+data[i].id+"\",\""+data[i].idp+"\",\""+data[i].numerocq+"\",\""+data[i].quantite+"\",\""+data[i].numerodecompte+"\",\""+data[i].numerops+"\",\""+data[i].matriculesaisie+"\",\""+data[i].id_mot_rj+"\",\""+data[i].id_et+"\",\""+data[i].echant+"\",true,\""+libelle_etat_reprise_fini+"\");'>"+(data[i].numerocq || 'aucun')+"</a></td>";
           ...
           // console.log(data[i]);
            ...
            if(libb.trim() == "")
              libb = "aucun";
            var modlaunch = "<td><a class='' href='#' data-toggle='modal' data-target='#grille-aglae' onclick='buildEtapesGrille("+ data[i].id_type_grille +", \""+ data[i].dossier +"\", \"" + data[i].lotclient + "\", " + data[i].matriculesaisie + ", " + data[i].matriculecq + ", \"" + data[i].numerofacture + "\", \"" + data[i].numeronuo + "\", \"" + data[i].id + "\", \"" + data[i].idp + "\", \"" + data[i].id_tpc + "\", \"" + data[i].designation_grille + "\");'>"+libb+"</a></td>";
            if(Number(niveaux)==2)
              modlaunch = " <td><a class=''>"+data[i].numerofacture+"</a></td>";
            else if(Number(niveaux)==1)
              modlaunch = "<td><a class='' href='#' data-toggle='modal' data-target='#grille-aglae' onclick='buildEtapesGrille("+ data[i].id_type_grille +", \""+ data[i].dossier +"\", \"" + data[i].lotclient + "\", " + data[i].matriculesaisie + ", " + data[i].matriculecq + ", \"" + data[i].numerofacture + "\", \"" + data[i].numeronuo + "\", \"" + data[i].id + "\", \"" + data[i].idp + "\", \"" + data[i].id_tpc + "\", \"" + data[i].designation_grille + "\" );'>"+libb+"</a></td>";
  ...
  /*
         ...
         //   console.log("--------------------------------------matriule saisie A "+matr+"\n  >>> data"+data[i].id_a);
          ...
          //modlaunch = " <td><a class=''  href='#' data-toggle='modal' data-target='#grille-aglae'>"+libb+"</a></td>";
  ...
  //"            <td class='"+classes+"'>"+data[i].typefav+"</td>"+
      ...
      //      "            <td class='"+classes+"'><button class=\"btn btn-warning\"  onclick='buildErreursCheckCq("+data[i].id+")'>Détails</button></td>" +
            `            <td class="${classes}" id="anomalies_${data[i].id}"> ${data[i].erreurs_cq} </td>`;
        ...
        //   buildErreursCheckCq(current.id);
        // });
    ...
    $.ajax({
      ...
      success: function(msg){
        ...
        if(Number(data.id_dossier)== 701 || Number(data.id_dossier)== 702  || Number(data.id_dossier)== 703  || Number(data.id_dossier)== 704 || Number(data.id_dossier)== 721 ){
          htm_td_num += "<td><a class='' href='#' data-toggle='modal' data-target='#grille-aglae' onclick='loadModal(\""+data.id+"\",\""+data.idp+"\",\""+data.numerocq+"\",\""+data.quantite+"\",\""+data.numerodecompte+"\",\""+data.numerops+"\",\""+data.matriculesaisie+"\",\""+data.id_mot_rj+"\",\""+data.id_et+"\",\""+data.echant+"\",true,\""+libelle_etat_reprise_fini+"\");'>"+(data.numerocq || 'aucun')+"</a></td>";
          ...
          var modlaunch = "<td><a class='' href='#' data-toggle='modal' data-target='#grille-aglae' onclick='loadModal(\""+data.id+"\",\""+data.idp+"\",\""+data.numerofacture+"\",\""+data.quantite+"\",\""+data.numeronuo+"\",\""+data.numerops+"\",\""+data.matriculesaisie+"\",\""+data.id_mot_rj+"\",\""+data.id_et+"\",\""+data.echant+"\",false,\""+libelle_etat_reprise_fini+"\");'>"+libb+"</a></td>";
          if(Number(niveaux)==2)
          {
          ...
          {
            modlaunch = "<td><a class='' href='#' data-toggle='modal' data-target='#grille-aglae' onclick='loadModal(\""+data.id+"\",\""+data.idp+"\",\""+data.numerofacture+"\",\""+data.quantite+"\",\""+data.numeronuo+"\",\""+data.numerops+"\",\""+data.matriculesaisie+"\",\""+data.id_mot_rj+"\",\""+data.id_et+"\",\""+data.echant+"\",false,\""+libelle_etat_reprise_fini+"\");'>"+libb+"</a></td>";
