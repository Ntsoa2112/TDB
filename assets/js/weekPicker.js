...
var setWeekCalendar = function(settingElement) {
    ...
    $(settingElement).datepicker({
        ...
        onSelect: function(dateText, inst) {
            ...
            endDate = new Date(datepickerValue.getFullYear(), datepickerValue.getMonth(), datepickerValue.getDate() - datepickerValue.getDay() + 6 +1);

          var dateFormat = inst.settings.dateFormat || $.datepicker._defaults.dateFormat;
          date_deb = $.datepicker.formatDate( dateFormat, startDate, inst.settings);
          date_fin = $.datepicker.formatDate( dateFormat, endDate, inst.settings);
